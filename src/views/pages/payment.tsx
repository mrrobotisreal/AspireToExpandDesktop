...
import { lessonPackages } from "@constants/prices";
...
const Payment: FC = () => {
  ...
  const handleSubmitPayment = async () => {
    ...
    if (error) {
      ...
      let numLessonsAdded: number;
      if (state.packageId === "1_lesson") {
        numLessonsAdded = 1;
      } else if (state.packageId === "3_lessons") {
        numLessonsAdded = 3;
      } else if (state.packageId === "6_lessons") {
        numLessonsAdded = 6;
      } else {
        numLessonsAdded = 12;
      }
