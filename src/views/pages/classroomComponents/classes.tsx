    ...
    <Box>
      ...
      <List>
        {classes.map((upcomingClass) => (
          <Box key={upcomingClass.teacherID}>
            <Tooltip
              title={intl.formatMessage(
                { id: "classroom_upcomingClassTooltip" },
                {
                  teacher: upcomingClass.preferredName,
      ...
      {/* NOTE: This may not be included on the student side or more likely it will be a different component to request scheduling a class */}
      {/* <Box
        sx={{
          display: "flex",
        ...
        <Stack spacing={2} direction="row">
          ...
          >
            <Text variant="button" fontFamily={regularFont}>
              {intl.formatMessage({ id: "classroom_scheduleNewClass" })}
            </Text>
          </Button>
        </Stack>
      </Box> */}
      ...
      >
        ...
        <DialogContent>
          ...
          >
            <Text variant="body1" fontFamily={regularFont} fontWeight="bold">
              {intl.formatMessage({ id: "classroom_inputTeacher" })}:
            </Text>
            <Autocomplete
              sx={{ minWidth: 300 }}
                ...
                <TextField
                  ...
                  helperText={
                    isSelectedStudentInvalid
                      ? intl.formatMessage({
                          id: "classroom_inputTeacherError",
                        })
                      : ""
                  }
                />
        ...
        <DialogActions>
          ...
          >
            <Text variant="button" fontFamily={regularFont}>
              {intl.formatMessage({ id: "common_schedule" })}
            </Text>
          </Button>
        </DialogActions>
      </Dialog>
